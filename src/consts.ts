...
export const SITE_TAB = "bakeery";
export const SITE_TITLE = "bakeery 🧊";
export const SITE_DESCRIPTION = "A blog template";
export const DATE_FORMAT = "ddd MMM DD YYYY";

// User profile information
export const USER_NAME = "EveSunMaple";
export const USER_SITE = "https://demo.saroprock.com"
...
export const menuItems = [
  ...
  }, // Friends page
  {
    id: "contact",
    text: "Contact",
    href: "mailto:contact.ethic.bakeery@gmail.com", // Contact email
...
export const socialIcons = [
  ...
  {
    href: "www.linkedin.com/in/abubakar-usman-011115263",
    ariaLabel: "BiliBili",
    title: "BiliBili",
